    ...
    <div className="flex justify-center items-center h-[100vh] bg-blue-100">
        ...
        <form className="p-2 h-[400px] w-[420px] bg-blue-400 rounded-lg" required>
            <div className="w-full mt-2 text-center">
                <p className="w-full text-xl  font-bold">Sign-In</p>
            </div>
            <div className="ml-2">
                <label className="  ">
            ...
            <div className="ml-2">
                <label>
                <p className="mt-2 mb-1 font-semibold font-sans text-xl " >Email:</p>
                </label>
                <input className=" h-[40px] w-[391px] border outline-none text-lg rounded-lg" required type="email"/>
            </div>
            <div className="ml-2">
                <label>
            ...
            <Link to={"/login"}><button  className="bg-blue-900 w-full mt-4 h-[50px] rounded-lg text-white font-mono">Sign-In</button></Link>
                <div className="w-full mt-2">
                    <p className="w-full text-center text-lg">Already signed-in? <Link to="/login" className="font-mono font-semibold">Login</Link></p>
                </div>
            </div>
        </form>
    </div>
